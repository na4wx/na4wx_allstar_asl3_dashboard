...
// rpt.conf through the local dashboard doesn't restart asl3-gui). The
// cloud's own device list page was already unaffected, since it relays
// config.listNodes live rather than reading this cached copy.
